...
class DigitalHumanPipelineUI(PipelineUI):
    ...
    def _build_tts_kwargs(self, video_params: dict, text: str, output_path: str) -> dict:
        ...
        if tts_inference_mode == "local":
            ...
            if video_params.get("minimax_model"):
                tts_kwargs["minimax_model"] = video_params["minimax_model"]
            if video_params.get("minimax_emotion"):
                tts_kwargs["minimax_emotion"] = video_params["minimax_emotion"]
        else:
                ...
                try:
                    ...
                    async def generate_digital_human_video():
                        ...
                        if mode == "customize":
                            ...
                            tts_kwargs = self._build_tts_kwargs(video_params, generated_text, audio_path)
